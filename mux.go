...
import (
	...
	"github.com/Satoshi-Tb/go_todo_app/handler"
	"github.com/Satoshi-Tb/go_todo_app/service"
...
func NewMux(ctx context.Context, cfg *config.Config) (http.Handler, func(), error) {
	...
	dt := &handler.DelTask{
		Service:   &service.DelTask{DB: db, Repo: &r},
		Validator: v,
	}
